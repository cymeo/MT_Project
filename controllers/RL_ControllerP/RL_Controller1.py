...
steps = 300
episodes = 10000 
checkpoint_callback = CheckpointCallback(save_freq=1000*steps, save_path="./models/", name_prefix="ppo1")

model.learn(total_timesteps= steps*episodes, tb_log_name= "PPO_log1", callback=checkpoint_callback)   
model.save("ppo11")
