...
checkpoint_callback = CheckpointCallback(save_freq= steps/5*episodes, save_path="./models/", name_prefix="ppo3_1")
model.learn(total_timesteps= steps*episodes, tb_log_name= "PPO_log3_1", callback=checkpoint_callback)   
