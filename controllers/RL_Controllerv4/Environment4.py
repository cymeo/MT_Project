...
class WeBot_environment(Env):
    ...
    def __init__(self):
        ...
        self.weights = np.array([0.1,0.03,5,100]) 
        self.max_step = 1000
        super().__init__()
        # Define action and observation space
        
        self.action_space = spaces.Box(low= -3.13, high = 3.13, shape = (6,))
        #observation: Endeffector pose, motor angles, Goal Pose, arm pose, velocity and distance 
    ...
    def get_observation(self):
        ...
        self.d_arm =  np.array([np.linalg.norm(p_ee-p_arm)])
